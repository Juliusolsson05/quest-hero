...
````yaml /openapi.json delete /api/v1/sessions/{session_id}
openapi: 3.1.0
info:
  description: >-
...
paths:
  /api/v1/sessions/{session_id}:
    delete:
      ...
      description: >-
        Delete a session and all related turns, events, and internal state. Only
        the session creator (`created_by`) may delete it. Idempotent if already
        gone.
      parameters:
