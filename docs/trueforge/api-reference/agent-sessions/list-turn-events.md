...
````yaml /openapi.json get /api/v1/sessions/{session_id}/turns/{turn_id}/events
openapi: 3.1.0
info:
  description: >-
...
paths:
  /api/v1/sessions/{session_id}/turns/{turn_id}/events:
    get:
      ...
      description: >-
        Paginated persisted events for a turn (insertion order by default). Only
        the session creator (`created_by`) may list events.
      parameters:
