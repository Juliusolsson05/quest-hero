...
<AccordionGroup>
  ...
  <Accordion title="Tool approval (API only)" icon="user-shield">
    ...
    <Frame caption="The chat UI pauses on a sensitive tool call with Allow / Deny.">
      <img src="https://mintcdn.com/trueforge/ao4vM9E64RebschW/images/hitl.png?fit=max&auto=format&n=ao4vM9E64RebschW&q=85&s=1ff4c000a55ebb3236f1e9a3831c77b8" alt="Chat UI pausing on a tool call, showing the request payload with Allow and Deny buttons" width="3022" height="1722" data-path="images/hitl.png" />
    </Frame>
  ...
  <Accordion title="Generative UI" icon="chart-column">
    ...
    <Frame caption="A Generative UI response with a chart rendered inline in chat.">
      <img src="https://mintcdn.com/trueforge/ao4vM9E64RebschW/images/generative-ui.png?fit=max&auto=format&n=ao4vM9E64RebschW&q=85&s=85f1169f76e2ff698870dbaebc67cfdf" alt="Rendered Generative UI response with an inline bar chart comparing options" width="3022" height="1722" data-path="images/generative-ui.png" />
    </Frame>
  ...
  <Accordion title="Ask clarifying questions" icon="circle-question">
    ...
    <Frame caption="The chat UI renders the question and options as a selectable card.">
      <img src="https://mintcdn.com/trueforge/ao4vM9E64RebschW/images/ask-user-questions.png?fit=max&auto=format&n=ao4vM9E64RebschW&q=85&s=30918d59ad92aa50440b83591a62b0b1" alt="Chat UI showing an agent question with multiple-choice options and a Submit button" width="3022" height="1722" data-path="images/ask-user-questions.png" />
    </Frame>
  ...
  <Accordion title="Dynamic sub-agents" icon="diagram-project">
    ...
    <Frame caption="The agent fans out to parallel subagents, each shown as its own trace under Agent steps.">
      <img src="https://mintcdn.com/trueforge/7pqgEqyMkoJ-lzAO/images/subagents.png?fit=max&auto=format&n=7pqgEqyMkoJ-lzAO&q=85&s=71303f49f9a46501a86405f978121298" alt="Chat UI showing three parallel subagents — MCP research, Agent governance research, A2A protocol research — under Agent steps" width="3022" height="1722" data-path="images/subagents.png" />
    </Frame>
