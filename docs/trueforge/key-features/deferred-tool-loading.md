...
> Control whether MCP tool definitions are preloaded into agent context or discovered on demand.
...
<Columns cols={2}>
  <Frame caption="Off (default) — tools are discovered on demand.">
    <img src="https://mintcdn.com/trueforge/BoQVSnwdiHfKQrMv/images/preload-tools-off.png?fit=max&auto=format&n=BoQVSnwdiHfKQrMv&q=85&s=fe27ce85322c6e0ad99262302dbab275" alt="Save Agent dialog with a connector's preload toggle off; the tooltip reads Preload tools OFF — the agent discovers tools on demand, lighter context upfront" width="3022" height="1722" data-path="images/preload-tools-off.png" />
  </Frame>

  <Frame caption="On — tool definitions load into context upfront.">
    <img src="https://mintcdn.com/trueforge/BoQVSnwdiHfKQrMv/images/preload-tools-on.png?fit=max&auto=format&n=BoQVSnwdiHfKQrMv&q=85&s=0d86686a6d24ae83b51b8aeeab77cc99" alt="Save Agent dialog with a connector's preload toggle on and highlighted; the tooltip reads Preload tools ON — tool definitions load into context upfront" width="3022" height="1722" data-path="images/preload-tools-on.png" />
  </Frame>
</Columns>
...
<Frame caption="Deferring tool loading keeps the agent's context window lean">
  <img src="https://mintcdn.com/trueforge/yAtU429u9xye0nsl/images/preload-tools.png?fit=max&auto=format&n=yAtU429u9xye0nsl&q=85&s=d946fb15efc3b796a73d64ceb274bcbf" alt="Comparison showing context window usage with tool preloading off versus on across many MCP servers" width="1521" height="1034" data-path="images/preload-tools.png" />
</Frame>
